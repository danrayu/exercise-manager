...
class ViewScheduleFragmentRVAdapter(private val itemList: MutableList<DisplayableItem>, val context: Context) : RecyclerView.Adapter<ViewScheduleFragmentRVAdapter.BaseViewHolder>() {
