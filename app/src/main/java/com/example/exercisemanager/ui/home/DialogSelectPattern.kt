...
class DialogSelectPattern(private val pattern: MutableList<Boolean>, private val listener: OnPatternSelected) : DialogFragment(), SelectableBubblesLVA.OnElementPress {
    ...
    private lateinit var rvAdapter: SelectableBubblesLVA
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            rvAdapter = SelectableBubblesLVA(this, requireContext())
            setupRV()
